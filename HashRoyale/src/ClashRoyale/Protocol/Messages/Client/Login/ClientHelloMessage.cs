...
namespace ClashRoyale.Protocol.Messages.Client.Login
{
    public class ClientHelloMessage : PiranhaMessage
    {
        ...
        {
            Logger.Log(
                $"ClientHello: Protocol={Protocol} KeyVersion={KeyVersion} Major={MajorVersion} Minor={MinorVersion} Build={Build} FingerprintSha={FingerprintSha} DeviceType={DeviceType} AppStore={AppStore}",
